...
class CantileverDataset(Dataset):
    def __init__(self, folder_inputs, folder_outputs=None):
        ...
        if folder_outputs is not None:
            ...
            # Store the minimum and maximum stress values.
            self.minimum_stress, self.maximum_stress = np.min(self.stresses), np.max(self.stresses)
...
if __name__ == '__main__':
    ...
    for i, (test_input, _) in enumerate(test_dataloader):
        ...
        test_output *= train_dataset.maximum_stress - train_dataset.minimum_stress
        test_output += train_dataset.minimum_stress
        pass
